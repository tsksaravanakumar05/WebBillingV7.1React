        ...
        <div className="so-layout">
          <main className="so-panel">
            <div className="so-panel-header">
              <div className="so-panel-eyebrow">Purchase Detailed</div>
              <div className="so-panel-title">Purchase Bill Detailed Report</div>
            </div>

            <div className="so-form-grid">
              <label className="so-label" htmlFor="pd-supplier">Supplier Name</label>
