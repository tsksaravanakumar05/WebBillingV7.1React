...
//  control flow are 100% unchanged from the original DepartmentMaster.jsx.
// ─────────────────────────────────────────────────────────────────────────────
...
const ALL_COLUMNS = [
  { field: "DepartmentName", label: "Department Name", width: 220 },
      ...
      <div className="bm-layout">
        <div className="bm-card">
          <div className="bm-card-header">
            <div className="bm-card-header-title">Department Master</div>
            <button type="button" className="bm-close-x" aria-label="Close" onClick={handleEsc}>✕</button>
          </div>

          <div className="bm-card-body">
            <div className="bm-report-title">Department Master</div>
            ...
            <div className="bm-grid-wrap">
              ...
              {grid.length === 0 && !loading && (
                <div className="bm-empty">No records. Press ➕ Add Row to add a department.</div>
              )}
            </div>
