  ...
  />
      ...
      <style>{`
        ...
        .si-modal {
          ...
          box-shadow: 0 16px 48px rgba(0,0,0,.25); border: 1px solid #d0ddf5;
        }
        .si-modal-hdr {
          background: linear-gradient(135deg,#1b3a8f,#1f65de);
          padding: 10px 14px; display: flex; align-items: center;
          color: #fff; font-size: 13px; font-weight: 700;
        }
        .si-modal-hdr span { flex: 1; }
        .si-modal-hdr button {
          background: rgba(255,255,255,.15); border: none; color: #fff;
        ...
        .si-btn {
          ...
          border: 1px solid #c5d8f8; border-radius: 4px;
          padding: 5px 12px; font-size: 11.5px; font-weight: 600;
          cursor: pointer; height: 30px; background: #fff; color: #1a2e4a;
          transition: all .12s;
        }
        .si-btn:hover { background: #f0f7ff; border-color: #1f65de; }
        .si-btn:disabled { opacity: .45; cursor: not-allowed; }
        .si-btn.sv { background: #1f65de; color: #fff; border-color: #1f65de; }
        .si-btn.sv:hover { background: #1750b0; }
        .si-btn.dl { color: #dc3545; border-color: #dc3545; }
        .si-btn.dl:hover { background: #fee2e2; }
        .si-select {
          height: 24px; border: 1px solid #b8ccee; border-radius: 3px;
